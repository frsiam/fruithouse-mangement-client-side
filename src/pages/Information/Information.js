...
const Information = () => {
    return (
        <div className="jumbotron my-5 container">
            <div className="row w-100">
                ...
                <div className="col-md-4">
                    <div className="card border-danger mx-sm-1 p-3">
                        ...
                        <div className="text-danger text-center mt-4"><h4>Hearts</h4></div>
                ...
                <div className="col-md-4">
                    <div className="card border-warning mx-sm-1 p-3">
                        ...
                        <div className="text-warning text-center mt-4"><h4>Inbox</h4></div>
